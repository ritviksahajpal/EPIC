...
##################################################################
import os, sys, logging, pdb, getopt, glob, zipfile, arcpy, csv, time
...
fname = base_dir+os.sep+'input'+os.sep+LIST_STATES
...
# Make spatial reference of SSURGO and land use data the same

# Combine SSURGO and land use data

# Compute centroid of each HSMU using zonal geometry

# Convert zonal geometry table into csv file
